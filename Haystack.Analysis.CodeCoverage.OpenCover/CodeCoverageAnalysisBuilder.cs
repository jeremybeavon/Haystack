...
{
    public sealed class CodeCoverageAnalysisBuilder : ICodeCoverageAnalysisProvider
    {
        public const string OutputDirectoryName = "coverage.opencover";

        private CodeCoverageClassLines currentClassLines;

        public IEnumerable<CodeCoverageAnalysis> AnalyzeCodeCoverage(IHaystackAnalysisConfiguration configuration)
        {
            List<CodeCoverageAnalysis> codeCoverageAnalysisList = new List<CodeCoverageAnalysis>();
            string passingCodeCoverageDirectory = GetCodeCoverageOutputDirectory(configuration.PassingTestOutputDirectory);
            string failingCodeCoverageDirectory = GetCodeCoverageOutputDirectory(configuration.FailingTestOutputDirectory);
        ...
        private static string GetCodeCoverageOutputDirectory(string outputDirectory)
        {
